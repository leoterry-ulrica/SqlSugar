...
namespace OrmTest
{
    public class Demo0_SqlSugarClient
    {
        ...
        private static void MasterSlave()
        {
            ...
            SqlSugarClient db = new SqlSugarClient(new ConnectionConfig()
            {
                ...
                SlaveConnectionConfigs = new List<SlaveConnectionConfig>() {
                     new SlaveConnectionConfig() { HitRate=10, ConnectionString=Config.ConnectionString } ,
                       new SlaveConnectionConfig() { HitRate=10, ConnectionString=Config.ConnectionString }
                } 
            });
        ...
        private static void SqlSugarClient()
        {
            ...
            var insertable = db.Insertable(new Order() { Name = "order1", CustomId = 1, Price = 0, CreateTime = DateTime.Now });
            var id = insertable.ExecuteReturnIdentity();
